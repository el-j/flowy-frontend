    ...
    <>
      ...
      <div className="mb-3 custom-file">
        <input
          ...
          multiple
        />
        <label className="custom-file-label" htmlFor="newSketch">
          Sketch File
        </label>
      </div>
      <div className="mb-3 custom-file">
        ...
        />
        <label className="custom-file-label" htmlFor="newMMD">
          Mermaid File
        </label>
      </div>
      <div className="mb-3 custom-file">
        <input
          ...
          type="file"
        />
        <label className="custom-file-label" htmlFor="newXML">
          Textmanagement XML
        </label>
      </div>

      <Button type="submit" variant="outline-secondary" onClick={(e) => onSubmit(e)}>
        Upload + Create
      </Button>
    </>
  );
